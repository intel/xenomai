...
var manifest_1 = []typeRepoGit{
	...
	typeRepoGit{
		Name:   "meta-xenomai-intel",
		SrcURI: "https://github.com/intel/meta-xenomai-intel.git",
...
const bblayers_conf_manifest_1_template = `
...
BBLAYERS ?= " \
  ...
  {{.SnapshotDir}}meta-xenomai-intel \
  "
`

///////////////////////////////////////////////////////////////////////////////

const local_conf_manifest_1_template = `
#
